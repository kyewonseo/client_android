...
Java_org_airpage_facedetectopencv_MainActivity_loadCascade(JNIEnv *env, jobject instance,
...
Java_org_airpage_facedetectopencv_MainActivity_detect(JNIEnv *env, jobject instance,
